...
@section('body')
    <section>
        <div class="hero-slider position-relative">
            <div class="hero-slider-item py-160" style="background-image: url(front/images/banner/banner-1.jpg);"
            ...
            <div class="hero-slider-item py-160" style="background-image: url(front/images/banner/banner-2.jpg);"
            ...
            <div class="hero-slider-item py-160" style="background-image: url(front/images/banner/banner-3.jpg);" data-icon="ti-money"
                 data-text="Finance">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
            ...
            <div class="hero-slider-item py-160" style="background-image: url(front/images/banner/banner-4.jpg);"
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body p-0">
                            ...
                            <p class="card-text mx-2 mb-0">Lorem ipsum dolor amet consecte tur
                                ...
                                nostrud.</p>
                            <a href="{{ route('front.course.details') }}" class="btn btn-secondary translateY-25">Read
                                More</a>
                        </div>
                    </div>
                </div>
    ...
    <section class="about section-sm overlay" style="background-image: url(front/images/background/about-bg.jpg);">
        <div class="container">
            <div class="row">
            ...
            <div class="row work-slider">
                <div class="col-lg-3 px-0">
                    <div class="work-slider-image">
                        <img class="img-fluid w-100" src="{{ asset('/') }}front/images/works/work-1.jpg" alt="work-image">
                        <div class="image-overlay">
                            <a class="popup-image" data-effect="mfp-zoom-in" href="{{ asset('/') }}front/images/works/work-1.jpg">
                                <i class="ti-search"></i>
                            </a>
                ...
                <div class="col-lg-3 px-0">
                    <div class="work-slider-image">
                        <img class="img-fluid w-100" src="{{ asset('/') }}front/images/works/work-2.jpg" alt="work-image">
                        <div class="image-overlay">
                            <a class="popup-image" data-effect="mfp-zoom-in" href="{{ asset('/') }}front/images/works/work-2.jpg">
                                <i class="ti-search"></i>
                            </a>
                            <a class="h4" href="project-single.html">Cras Sed Elit Sit Amet.</a>
                            <p>by Admin</p>
                ...
                <div class="col-lg-3 px-0">
                    <div class="work-slider-image">
                        <img class="img-fluid w-100" src="{{ asset('/') }}front/images/works/work-3.jpg" alt="work-image">
                        <div class="image-overlay">
                            <a class="popup-image" data-effect="mfp-zoom-in" href="{{ asset('/') }}front/images/works/work-3.jpg">
                                <i class="ti-search"></i>
                            </a>
                            <a class="h4" href="project-single.html">Cras Sed Elit Sit Amet.</a>
                            <p>by Admin</p>
                ...
                <div class="col-lg-3 px-0">
                    <div class="work-slider-image">
                        <img class="img-fluid w-100" src="{{ asset('/') }}front/images/works/work-4.jpg" alt="work-image">
                        <div class="image-overlay">
                            <a class="popup-image" data-effect="mfp-zoom-in" href="{{ asset('/') }}front/images/works/work-4.jpg">
                                <i class="ti-search"></i>
                            </a>
                            <a class="h4" href="project-single.html">Cras Sed Elit Sit Amet.</a>
                            <p>by Admin</p>
    ...
    <section class="mission section">
        <div class="container">
            <div class="row">
                ...
                <!-- chart -->
                <div class="col-lg-6">
                    <img src="{{ asset('/') }}front/images/chart.png" alt="chart" class="img-fluid w-100">
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- promo-video -->
    <section class="promo-video overlay section" style="background-image: url(front/images/background/promo-video.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-12">
    ...
    <section class="cta overlay-primary py-50 text-center text-lg-left" style="background-image: url(front/images/background/cta.jpg);">
        <div class="container">
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                    <div class="card">
                        <div class="card-img-wrapper overlay-rounded-top">
                            <img class="card-img-top" src="{{ asset('/') }}front/images/blog/blog-1.jpg" alt="blog-thumbnail">
                        </div>
                        <div class="card-body p-0">
                            <div class="d-flex">
                ...
                <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                    <div class="card">
                        <div class="card-img-wrapper overlay-rounded-top">
                            <img class="card-img-top" src="{{ asset('/') }}front/images/blog/blog-2.jpg" alt="blog-thumbnail">
                        </div>
                        <div class="card-body p-0">
                            <div class="d-flex">
                                <div class="py-3 px-4 border-right text-center">
